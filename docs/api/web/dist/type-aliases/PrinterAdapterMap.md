...
[labelmanager](../../../modules.md) / [web/dist](../README.md) / PrinterAdapterMap

# Type Alias: PrinterAdapterMap

> **PrinterAdapterMap** = `Readonly`\<`Record`\<`string`, [`PrinterAdapter`](../../../core/dist/interfaces/PrinterAdapter.md)\>\>
