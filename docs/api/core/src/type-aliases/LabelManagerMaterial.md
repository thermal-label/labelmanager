...
[labelmanager](../../../README.md) / [core/src](../README.md) / LabelManagerMaterial

# Type Alias: LabelManagerMaterial

> **LabelManagerMaterial** = `"standard"` \| `"permanent-polyester"` \| `"flexible-nylon"` \| `"durable"` \| `"rhino-vinyl"` \| `"rhino-permanent-polyester"` \| `"rhino-flexible-nylon"` \| `"rhino-heat-shrink"` \| `"rhino-non-adhesive-tag"` \| `"rhino-self-laminating"`
