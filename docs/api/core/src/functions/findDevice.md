...
[labelmanager](../../../README.md) / [core/src](../README.md) / findDevice

# Function: findDevice()

> **findDevice**(`vid`, `pid`): [`LabelManagerDevice`](../type-aliases/LabelManagerDevice.md) \| `undefined`
...
[`LabelManagerDevice`](../type-aliases/LabelManagerDevice.md) \| `undefined`
